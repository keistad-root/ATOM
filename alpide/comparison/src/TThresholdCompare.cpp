...
void TThresholdCompare::compareStdDev() {
	...
	Int_t lineWidth = mStdevConfig.hasKey("line_width") ? stod(mStdevConfig.find("line_width")) : 1;
	...
	Int_t markerWidth = mStdevConfig.hasKey("marker_size") ? stod(mStdevConfig.find("marker_size")) : 1;
