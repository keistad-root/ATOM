...
tmux send-keys -t g4simulation:1 './G4Simulation L1F4AX_W0990' C-m
tmux send-keys -t g4simulation:2 './G4Simulation L1F4AX_W1002' C-m
tmux send-keys -t g4simulation:3 './G4Simulation L1F4AX_W1014' C-m
tmux send-keys -t g4simulation:4 './G4Simulation L1F4AX_W1026' C-m
tmux send-keys -t g4simulation:5 './G4Simulation L1F4AX_W1038' C-m
tmux send-keys -t g4simulation:6 './G4Simulation L1F4AX_W1050' C-m
tmux send-keys -t g4simulation:7 './G4Simulation L1F4AX_W1062' C-m
tmux send-keys -t g4simulation:8 './G4Simulation L1F4AX_W1074' C-m
tmux send-keys -t g4simulation:9 './G4Simulation L1F4AX_W1086' C-m
tmux send-keys -t g4simulation:10 './G4Simulation L1F4AX_W1098' C-m
tmux send-keys -t g4simulation:11 './G4Simulation L1F4AX_W1110' C-m
