...
void AnalysisManager::Book() {
    ...
    G4cout << "1\t" << fScoringALPIDECircuit << G4endl;
    G4cout << "2\t" << fScoringALPIDEEpitaxial << G4endl;
    G4cout << "3\t" << fScoringCarrierBoardLogical << G4endl;
    fScoringVolumes[fScoringALPIDECircuit] = 1;
    fScoringVolumes[fScoringALPIDEEpitaxial] = 2;
    fScoringVolumes[fScoringCarrierBoardLogical] = 3;
